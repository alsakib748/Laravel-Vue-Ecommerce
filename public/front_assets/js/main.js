...
=============================================*/
    $(window).on("load", function () {
        if ($(".navigation .scroll, .off-canvas-widget.scroll").length) {
            $(
                ".navigation .scroll, .off-canvas-widget.scroll",
            ).mCustomScrollbar({
                mouseWheelPixels: 50,
                scrollInertia: 0,
            });
...
=============================================*/
    ...
    $('a[data-toggle="tab"]').on("shown.bs.tab", function (e) {
        $(".features-product-active, .trending-product-active").slick(
            "setPosition",
        );
    });
...
=============================================*/
	...
	=    		Isotope	Active  	      =
=============================================*/
    $(".new-arrival-active, .cosmetics-product-active").imagesLoaded(
        function () {
            // init Isotope
            var $grid = $(
                ".new-arrival-active, .cosmetics-product-active",
            ).isotope({
