...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="col pb-3">
            <button type="button" class="btn btn-outline-info px-5 radius-30" data-bs-toggle="modal" data-bs-target="#staticBackdrop" onclick="saveData('0','','')">Add Brand</button>
        </div>
              ...
              <table id="example2" class="table table-striped table-bordered">
                ...
                @if($data->isNotEmpty())
                    ...
                    <tr>
                        ...
                        <td>{{ $list->name }}</td>
                        <td>
                            <img src="{{ asset($list->image) }}" alt="" style="width: 120px;height: 90px;" class="img-fluid" />
                        </td>
                        {{-- <td>{{ $list->updated_at }}</td> --}}
                        <td>
                            <button type="button" class="btn btn-outline-success px-4 radius-30" data-bs-toggle="modal" data-bs-target="#staticBackdrop" onclick="saveData('{{ $list->id }}','{{ $list->name }}','{{ $list->image }}')">Edit</button>
