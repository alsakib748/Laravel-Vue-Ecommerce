<template>
    ...
    <header class="header-style-two">
                ...
                <div class="row">
                    <div class="col-12">
                                ...
                                <div class="header-action d-none d-md-block">
                                    <ul>
                                                ...
                                                <li v-if="cartCount > 0" v-for="item in cartProduct" :key="item.id"
                                                    ...
                                                    <div class="cart-content">
                                                        ...
                                                        <div class="cart-price">
                                                            <span class="new">${{
                                                                item.products.product_attributes[0].price }}</span>
                                                            <span><del>${{
                                                                item.products.product_attributes[0].mrp
                                                                    }}</del></span>
                                                        </div>
                                                    </div>
                                                    <div class="del-icon">
                                                        <a href="javascript:void(0)"
                                                            @click="removeCartData(item.products.id, item.products.product_attributes[0].id, 1)"><i
                                                                class=" far
                                                            fa-trash-alt"></i></a>
                                                    </div>
                                                </li>
                                        ...
                                        <li class="header-profile">
                                            <a href="#"><i class="flaticon-user-profile"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </nav>
                        ...
                        <div class="mobile-menu">
                            ...
                            <nav class="menu-box">
                                <div class="nav-logo">
                                    <a href="index.html"><img src="../assets/img/logo/logo.png" alt="" title="" /></a>
                                </div>
        ...
        <div class="sidebar-toggle-btn">
            <a href="#" class="navSidebar-button"><img src="../assets/img/icon/sidebar_toggle_icon.png" alt="" /></a>
        </div>
                        ...
                        <div class="sidebar-info-contents">
                            <div class="content-inner">
                                ...
                                <div class="contact-info">
                                    ...
                                    <ul>
                                        <li>
                                            <span class="flaticon-phone-call"></span><a href="tel:123456789">+9 325 444
                                                0000</a>
                                        </li>
                                        <li>
                                            <span class="flaticon-email"></span><a
                                                href="mailto:adara@info.com">adara@info.com</a>
                                        </li>
                                        <li>
                                            <span class="flaticon-place"></span>71 Park Lan Street
                                            2355 NY
                                        </li>
                                    </ul>
                                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="copyright-text">
                            <p>
                                &copy; 2021 <a href="index.html">adara</a>. All Rights
                                Reserved | Ph (+09) 456 457869
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6">
...
export default {
    ...
    watch: {
        // todo: tips:: use watch variable name and function name shuld be same
        cartProduct(val) {
            this.cartTotal = 0;
    ...
    methods: {
        ...
        , async addCoupon(coupon) {
            try {
                ...
                // console.log('coupon: ' + coupon + ' cartTotal: ' + this.oldCart);

                if (data.status == 200) {
                    // if (data.status == "Success") {
                    this.cartTotal = data.data.data.data;
                    this.couponName = data.data.data.couponName;
                    console.log('couponName: ' + this.couponName + ' cartTotal: ' + this.cartTotal);
                    // this.getCartData();
        ...
        async getCartData() {
            try {
                ...
                if (data.status == 200) {
                    ...
                    this.cartTotal = data.data.data.total;
