...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="col pb-3">
            <button type="button" class="btn btn-outline-info px-5 radius-30" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Add Home Banner</button>
        </div>
              ...
              <table id="example2" class="table table-striped table-bordered">
                ...
                @if($data->isNotEmpty())
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-outline-success px-4 radius-30" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Edit</button>
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <form id="formSubmit" action="{{ route() }}" method="POST" enctype="multipart/form-data">
    @csrf
